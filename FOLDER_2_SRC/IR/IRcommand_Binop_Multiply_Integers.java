...
public class IRcommand_Binop_Multiply_Integers extends IRcommand
{
	public TEMP t1;
	public TEMP t2;
	public TEMP dst;
	
	public IRcommand_Binop_Multiply_Integers(TEMP dst,TEMP t1,TEMP t2)
	{
		this.dst = dst;
		this.t1 = t1;
		this.t2 = t2;
	...
	public void MIPSme()
	{
		...
		/******************************************************/
		TEMP t1_mult_t2 = TEMP_FACTORY.getInstance().getFreshTEMP();
		...
		/* [4] t4 := t1 + t2 */
		/*********************/
		sir_MIPS_a_lot.getInstance().mult(t1_mult_t2,t1,t2);
		
		/********************************************************/
		/* [5] if (32767 <  t1_mult_t2) goto label_overflow;    */
		/*     if (32767 >= t1_mult_t2) goto label_no_overflow; */
		/********************************************************/
		sir_MIPS_a_lot.getInstance().blt(t1_mult_t2,intMin,label_neg_overflow);
		...
		sir_MIPS_a_lot.getInstance().mult(dst,t1,t2);
		sir_MIPS_a_lot.getInstance().jump(label_end);
